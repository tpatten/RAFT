...
# python -u train.py --name raft-dubbo --stage dubbo --validation awi_uv --restore_ckpt checkpoints/raft-sintel.pth --gpus 0 --num_steps 50000 --batch_size 2 --lr 0.0001 --image_size 600 1232 --wdecay 0.00001 --gamma=0.85 --wandb
python -u train.py --name raft-dubbo --stage dubbo --validation awi_uv --restore_ckpt checkpoints/raft-sintel.pth --gpus 0 --num_steps 50000 --batch_size 2 --lr 0.00025 --image_size 600 1232 --wdecay 0.0001 --gamma=0.85 --wandb